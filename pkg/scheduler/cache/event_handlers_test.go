...
func TestSchedulerCache_AddPodGroupAlpha1(t *testing.T) {
	namespace := "test"
	owner := buildOwnerReference("j1")
	...
	for i, test := range tests {
		...
		cache.AddPodGroupAlpha1(test.PodGroup)
...
func TestSchedulerCache_AddPodGroupAlpha2(t *testing.T) {
	...
	for i, test := range tests {
		...
		cache.AddPodGroupAlpha2(test.PodGroup)
		jobID := api.JobID("test/j1")
...
func TestSchedulerCache_UpdatePodGroupAlpha1(t *testing.T) {
	namespace := "test"
	owner := buildOwnerReference("j1")
	...
	for i, test := range tests {
		...
		cache.UpdatePodGroupAlpha1(test.OldPodGroup,test.NewPodGroup)
		jobID := api.JobID("test/j1")
...
func TestSchedulerCache_UpdatePodGroupAlpha2(t *testing.T) {
	...
	for i, test := range tests {
		...
		cache.UpdatePodGroupAlpha2(test.OldPodGroup,test.NewPodGroup)
		jobID := api.JobID("test/j1")
...
func TestSchedulerCache_DeletePodGroupAlpha1(t *testing.T) {
	...
	for i, test := range tests {
		...
		cache.DeletePodGroupAlpha1(test.PodGroup)
		jobID := api.JobID("test/j1")
...
func TestSchedulerCache_DeletePodGroupAlpha2(t *testing.T) {
	...
	for i, test := range tests {
		...
		cache.DeletePodGroupAlpha2(test.PodGroup)
		jobID := api.JobID("test/j1")
